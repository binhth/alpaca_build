...
/**
 * Provides the local service interface for DictCollectionAlpacaJS. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see DictCollectionAlpacaJSLocalServiceUtil
...
public interface DictCollectionAlpacaJSLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DictCollectionAlpacaJSLocalServiceUtil} to access the dict collection alpaca j s local service. Add custom service methods to {@link com.dict.dao.service.impl.DictCollectionAlpacaJSLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
